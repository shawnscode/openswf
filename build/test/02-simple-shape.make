...
ifeq ($(config),debug)
  RESCOMP = windres
  TARGETDIR = ../../bin
  TARGET = $(TARGETDIR)/02-simple-shape
  OBJDIR = obj/debug/02-simple-shape
  DEFINES += -DDEBUG
...
$(OBJDIR)/openswf_test_shape.o: ../../test/02-simple-shape/openswf_test_shape.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
